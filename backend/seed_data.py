...
company, _ = CompanyInfo.objects.get_or_create(
    ...
    defaults={
        "name": "高美基因科技有限公司",
        "slogan": "精准检测，赋能生命健康",
        "description": "高美基因科技有限公司是一家专注于基因组学研究和精准医学服务的高新技术企业。公司在DNA甲基化检测、基因突变分析、微卫星不稳定(MSI)检测和拷贝数变异(CNV)分析等领域拥有领先的技术平台和丰富的行业经验。我们致力于为医疗机构、科研院所和制药企业提供高质量的生物信息学分析服务。",
        "mission": "以精准的基因组分析技术，推动精准医学发展，助力个体化诊疗。",
        "vision": "成为国内领先的基因组学检测与生物信息分析服务平台。",
        "email": "contact@gaomeibio.com",
        "phone": "400-888-9999",
        "address": "中国杭州市余杭区文一西路998号海创园A座18层",
        "wechat": "高美基因",
        "founded_year": 2018,
    },
)
...
team_data = [
    ...
    {"name": "陈思琪", "position": "生信分析总监", "bio": "复旦大学生物信息学博士，带领团队完成超过10万例样本的生信分析。", "order": 4},
]
for td in team_data:
