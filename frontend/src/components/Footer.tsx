...
import { SITE_PHONE_DISPLAY, phoneTelHref } from "../content/siteContact";
  ...
  <footer className="site-footer">
    <div className="site-container footer-grid">
      <div>
        ...
        <div className="socials"><i className="fab fa-weixin" /><i className="fas fa-phone" /></div>
      </div>
      ...
      <div>
        ...
        <a href={phoneTelHref()}>电话咨询：{SITE_PHONE_DISPLAY}</a>
