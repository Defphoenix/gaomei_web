...
export const PRODUCTS: ProductItem[] = [
  {
    ...
    icon: "shield",
    accent: "#2f9e6b",
    image: "/assets/images/products/kit-welfare.webp",
  ...
  },
  {
    ...
    icon: "dna",
    accent: "#7357c8",
    image: "/assets/images/products/kit-susceptibility.webp",
    qr: "/assets/images/wechat_qrcode.jpg",
    qrLabel: "扫码咨询易感诊断",
    tags: ["易感基因", "遗传", "诊断"],
  ...
  },
  {
    ...
    icon: "target",
    accent: "#e9522e",
    image: "/assets/images/products/kit-meiganxin.webp",
    qr: "/assets/images/wechat_qrcode.jpg",
    qrLabel: "扫码购买美甘鑫",
    tags: ["cfDNA", "甲基化", "肝癌"],
  ...
  },
  {
    ...
    icon: "scan",
    accent: "#159ca3",
    image: "/assets/images/products/kit-meiganfei.webp",
    qr: "/assets/images/wechat_qrcode.jpg",
    qrLabel: "扫码购买美甘飞",
    tags: ["cfDNA", "甲基化", "肺癌"],
  ...
  },
  {
    ...
    icon: "microscope",
    accent: "#5740a8",
    image: "/assets/images/products/kit-screening.webp",
    qr: "/assets/images/wechat_qrcode.jpg",
    qrLabel: "扫码咨询早筛方案",
    tags: ["甲基化", "多组学", "早筛"],
  ...
  },
  {
    ...
    icon: "network",
    accent: "#8f2335",
    image: "/assets/images/products/kit-precision.webp",
    qr: "/assets/images/wechat_qrcode.jpg",
    qrLabel: "扫码咨询精准检测",
    tags: ["WES", "Panel", "TAPS"],
  ...
  },
  {
    ...
    icon: "report",
    accent: "#2b91c8",
    image: "/assets/images/products/kit-followup.webp",
    qr: "/assets/images/wechat_qrcode.jpg",
    qrLabel: "扫码咨询随访方案",
    tags: ["Panel", "随访", "监测"],
